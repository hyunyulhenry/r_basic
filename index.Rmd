...
knitr::include_graphics('images/tidymodel.png')
```
...
- https://github.com/hyunyulhenry/r_basic/blob/master/data/kospi.csv
- https://github.com/hyunyulhenry/r_basic/blob/master/data/kospi.xlsx
...
```{r fig.cap='한국복지패널 데이터', echo = FALSE, out.width="100%"}
...
raw = read_spss('data/Koweps_hpc16_2021_beta1.sav')
```
